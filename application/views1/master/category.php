                    ...
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <h4 class="card-title">Patient Category</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add Patient Title</a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    OPD <input type="checkbox" id="opd" name="opd">
                                                </div>
                                                <div class="col-md-2">
                                                    IPD <input type="checkbox" id="ipd" name="ipd" >
                                                </div>
                                                <div class="col-md-2">
                                                    LASER <input type="checkbox"  id="laser" name="laser">
                                                </div>
                                                <div class="col-md-3">
                                                    INJECTION <input type="checkbox"  id="injection" name="injection">
                                                </div>
                                               <div class="col-md-3">
                                                    INVESTIGATION <input type="checkbox"  id="investigation" name="investigation">
                                                </div>
                                            </div>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Category/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'name' },
             { data: 'amount' },
            ...
            success: function(data){
               ...
               if(data.msg != ''){
                $('#edit_data').html(data.msg);
                 ...
                 $('.modal-title').html('Edit Patient Category');
              } else if(data.error != ''){
                Swal.fire({title:"Warning!",text:""+data.error+"",type:"warning",confirmButtonClass:"btn btn-primary",buttonsStyling:!1});
              } else if(data.error_message) 
              {
