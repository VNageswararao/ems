...
class Profile extends CI_Controller {
	...
	public function saveprofile()
	{
		...
		$this->form_validation->set_rules('printable_company_address', 'Printable Company Address', 'trim|min_length[1]|max_length[100]');
	    ...
	    if($this->form_validation->run() == TRUE)
	    {
	    	...
	    	$data=$this->fetch_data($company_name,$license_no,$company_mobile,$company_phone,$email_id,$address,$printable_company_name,$printable_company_phone,$printable_company_mobile,$printable_emailid,$printable_company_address,$declaration,$gstin_no);
	...
	private function fetch_data($company_name,$license_no,$company_mobile,$company_phone,$email_id,$address,$printable_company_name,$printable_company_phone,$printable_company_mobile,$printable_emailid,$printable_company_address,$declaration,$gstin_no) 
    {
