                    ...
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <h4 class="card-title">Patient Title</h4>
                                </div>
                            ...
                            <form id="patient_title" action="#" method="post"> 
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Patient_title/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'name' },
             { data: 'description' },
...
function editdata(val)
{
    if(val>0)
    {
         $.ajax({
            type: "POST",
            url: 'Patient_title/editpatienttitle',
            dataType: "json",
            ...
            success: function(data){
               ...
               if(data.msg != ''){
                $('#edit_data').html(data.msg);
                 ...
                 $('.modal-title').html('Edit Patient Title');
              } else if(data.error != ''){
                Swal.fire({title:"Warning!",text:""+data.error+"",type:"warning",confirmButtonClass:"btn btn-primary",buttonsStyling:!1});
              } else if(data.error_message) 
              {
