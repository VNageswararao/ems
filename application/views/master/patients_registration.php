                                                ...
                                                <div class="col-sm-3 col-md-2">
                                                 ...
                                                 <div class="col-sm-3 col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control phone-inputmask"  id="mobileno" name="mobileno" >
                                                    </div>
                                                 </div>
                                                 <div class="col-sm-3 col-md-3">
                                                    <div class="form-group">
...
function getpateintdetails_followup() 
{
    $('#pp_date').html('');
     ...
     $.ajax({
            ...
            dataType: "json",
            data: {sdate:$('#search_date_fol').val(),csrf_test_name:$('#csrf_test_name').val()},
            success: function(data){
                $("#overlay").fadeOut(300);
               if(data.msg != ''){
...
function getappointmentopd(sel=0)
{
        ...
        }else
        {
          if($("#followup_appointment_type_id").val()=='') {
           Swal.fire({title:"Info!",
               ...
               type:"info",confirmButtonClass:"btn btn-primary",
               buttonsStyling:!1})
           return false;
        }
      ...
      if($('#patient_registration_id').val()==false){
          Swal.fire({title:"Info!",
    ...
    if(getval>0)
    {
      $.ajax({
        ...
        dataType: "json",
        data: {patient_registration_id:$('#patient_registration_id').val(),csrf_test_name:$('#csrf_test_name').val()},
        success: function(data){
...
function appointementpdo(sel,getval,idvak,cval){
            $.ajax({
            type: "POST",
    ...
    if(val>0)
    {
          Swal.fire({title:"Are you sure?",
            ...
            success: function(data){
                $("#overlay").fadeOut(300);
               if(data.msg != ''){
               Swal.fire({title:"Canceled",text:""+data.msg+"",type:"success",confirmButtonClass:"btn btn-success",buttonsStyling:!1});
              // table.draw();
...
function whitecell(val,patapt)
{
    if(val>0)
    {
         ...
         $.ajax({
            ...
            dataType: "json",
            data: {getid: val,patapt: patapt,csrf_test_name:$('#csrf_test_name').val()},
            success: function(data){
                $("#overlay").fadeOut(300);
               if(data.msg != ''){
                 $('#folmod').html(data.msg);
