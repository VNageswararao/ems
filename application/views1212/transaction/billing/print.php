...
<html>
 ...
 <br>
            <table style="width:100%;font-size: 14px;">
                <tr>
                    <td style="width: 60%">
                        Total  Amount: <?=number_format($grand_total,2)?><br>
                        Advance Amount: <?=number_format($advanced_amount,2)?><br>
                        Amount Paid by Patient: <?=number_format($grand_total,2)?><br>
                        <?=$mode?>: <?=number_format($grand_total,2)?><br>
                        Terms and Conditions:NB: <?=number_format($grand_total,2)?>/-(<?=$net_amount_in_words?>) was directly collected from patient.
                    </td>
                 </tr>
            </table>
            <br/><br/><br/><br/>
