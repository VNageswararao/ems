                    ...
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <h4 class="card-title">Charge Type</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add Charge Type</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <form id="Charge_type" action="#" method="post"> 
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="lastname">Consulation Charges List: <span class="text-danger">*</span></label>
                                            <select class="form-control" name="charge_id" id="charge_id">
                                                <option value="">Select Consulation Charges</option>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Charge_type/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'code' },
             { data: 'name' },
...
function savedata()
{
    if( $("#name").val()=='') {
         ...
         $.ajax({
            type: "POST",
            url: 'Charge_type/savedata',
            dataType: "json",
            data: $('#Charge_type').serialize(),
         ...
         $.ajax({
            ...
            success: function(data){
               ...
               if(data.msg != ''){
                 ...
                 $('.modal-title').html('Edit Charge type');
              } else if(data.error != ''){
                Swal.fire({title:"Warning!",text:""+data.error+"",type:"warning",confirmButtonClass:"btn btn-primary",buttonsStyling:!1});
              } else if(data.error_message) 
              {
