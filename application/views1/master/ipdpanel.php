                    ...
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                ...
                                <h4 class="card-title">IPD Consultation Charge</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add IPD Consultation Charge</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <form id="Ipdpanel" action="#" method="post"> 
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Ipdpanel/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'name' },
             { data: 'amount' },
...
function savedata()
{
    if( $("#name").val()=='') {
         ...
         $.ajax({
            type: "POST",
            url: 'Ipdpanel/savedata',
            dataType: "json",
            data: $('#Ipdpanel').serialize(),
         ...
         $.ajax({
            ...
            success: function(data){
               ...
               if(data.msg != ''){
                 ...
                 $('.modal-title').html('Edit IPD Consultation Charge');
              } else if(data.error != ''){
                Swal.fire({title:"Warning!",text:""+data.error+"",type:"warning",confirmButtonClass:"btn btn-primary",buttonsStyling:!1});
              } else if(data.error_message) 
              {
